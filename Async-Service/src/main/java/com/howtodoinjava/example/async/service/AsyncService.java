...
public class AsyncService {
	...
	public CompletableFuture<EmployeeNames> getEmployeeName() throws InterruptedException 
	{
		...
		EmployeeNames employeeNameData = restTemplate.getForObject("http://localhost:9080/names", EmployeeNames.class);
	...
	public CompletableFuture<EmployeeAddresses> getEmployeeAddress() throws InterruptedException 
	{
		...
		EmployeeAddresses employeeAddressData = restTemplate.getForObject("http://localhost:9080/addresses", EmployeeAddresses.class);
	...
	public CompletableFuture<EmployeePhone> getEmployeePhone() throws InterruptedException 
	{
		...
		EmployeePhone employeePhoneData = restTemplate.getForObject("http://localhost:9080/phones", EmployeePhone.class);
