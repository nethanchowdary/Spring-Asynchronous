...
public class EmployeeDataController 
{
	...
	public EmployeePhone getPhoneNumbers() 
	{
		...
		EmployeePhone employeePhone = new EmployeePhone();
		{
			...
			phoneNumberList.add("8142337273");
			phoneNumberList.add("9248177445");
	...
	public EmployeeNames getEmployeeName() 
	{
		...
		{
			employeeName1.setFirstName("nethan");
			employeeName1.setLastName("p");
		}
		{
			employeeName2.setFirstName("chandu");
			employeeName2.setLastName("g");
		}
